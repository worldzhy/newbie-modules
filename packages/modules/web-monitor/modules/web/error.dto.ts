 ...
 *
 * Covers both shapes returned by the web error service:
 * - Real-time / detail mode: a full ClickHouse row (WebError table).
 ...
 *
 * Every column is optional because grouped rows only carry a subset of the
 * full-row columns.
